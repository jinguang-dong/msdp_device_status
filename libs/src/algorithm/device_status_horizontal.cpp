...
void DeviceStatusHorizontal::Init()
{
    ...
    reportInfo_.move = 0;
    dataCallback_ = std::bind(&DeviceStatusHorizontal::StartAlgorithm, this,std::placeholders::_1,
        std::placeholders::_2);
...
void DeviceStatusHorizontal::GetData(int32_t sensorTypeId, void* sensorData)
{
    DEV_HILOGD(SERVICE, "enter");
...
void DeviceStatusHorizontal::LogicJudgment()
{
    DEV_HILOGD(SERVICE, "enter");
    ...
    DEV_HILOGD(SERVICE, "vectorModule_:%{public}f,pitch_:%{public}f,roll_:%{public}f", vectorModule_, pitch_, roll_);
...
void DeviceStatusHorizontal::RegisterCallback(
...
void DeviceStatusHorizontal::Report()
{
    DEV_HILOGD(SERVICE, "enter");
