...
constexpr int32_t ACCELERATION_VALID_THRESHOLD = 160;
constexpr int32_t ANGLE_180_DEGREE = 180;
constexpr int32_t ANGLE_20_DEGREE = 20;
constexpr int32_t ANGLE_80_DEGREE = 80;
constexpr int32_t ANGLE_110_DEGREE = 110;
