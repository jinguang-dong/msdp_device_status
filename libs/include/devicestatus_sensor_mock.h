...
#ifndef DEVICESTATUS_SENSOR_MOCK_H
#define DEVICESTATUS_SENSOR_MOCK_H
...
class DeviceStatusSensorMock final : public DevicestatusSensorInterface {
public:
    DeviceStatusSensorMock() = default;
    ~DeviceStatusSensorMock() = default;
    ...
    ErrCode RegisterCallback(const std::shared_ptr<DevicestatusSensorHdiCallback>& callback) override;
    ...
    std::shared_ptr<DevicestatusSensorHdiCallback> GetCallbackImpl()
    {
...
private:
    using Callback = std::function<void(DeviceStatusSensorMock*)>;
    std::shared_ptr<DevicestatusSensorHdiCallback> callback_;
    ...
    int32_t epFd_ {-1};
    std::mutex mutex_;
    int32_t enabledType_[DevicestatusDataUtils::DevicestatusType::TYPE_LID_OPEN + 1] {};
    bool alive_ {true};
};
} // namespace DeviceStatus
} // namespace Msdp
} // namespace OHOS
#endif // DEVICESTATUS_SENSOR_MOCK_H
