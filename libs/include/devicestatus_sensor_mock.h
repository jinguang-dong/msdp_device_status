...
class DeviceStatusSensorMock final : public ISensor {
public:
    ...
    ErrCode RegisterCallback(const std::shared_ptr<ISensor::SensorHdiCallback>& callback) override;
    ErrCode UnregisterCallback() override;
    ErrCode NotifyMsdpImpl(const Data& data);
    void GetDeviceStatusData();
    std::shared_ptr<SensorHdiCallback> GetCallbackImpl()
    {
