...
#ifndef MOTION_PICKUP_H
#define MOTION_PICKUP_H
...
class MotionPickup {
public:
    MotionPickup(const std::shared_ptr<SensorDataCallback> &sensorCallback) : sensorCallback_(sensorCallback) {};
    ~MotionPickup();
    void Init();
    void HandleIdle();
...
private:
    ...
    int pickupThreshold = PICKUP_THRESHOLD;
