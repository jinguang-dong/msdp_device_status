...
use fusion_data_rust::{
    CallingContext, GeneralCoordinationParam, GetCoordinationStateParam, IPlugin,
...
impl IPlugin for FusionCoordinationServer {
    ...
    fn get_param(
        ...
        let param = data
            .read::<GetCoordinationStateParam>()
            .or(Err(FusionErrorCode::Fail))?;
