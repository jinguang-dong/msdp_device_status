...
use fusion_utils_rust::{define_enum, FusionErrorCode, FusionResult};
...
pub trait IPlugin: Any + Send + Sync + std::panic::RefUnwindSafe {
    ...
    /// Interact with this service. This interface supplements functions of
    /// previous intefaces. Functionalities of this interface is service
    /// spicific.
    fn control(
        &self,
        context: &CallingContext,
