...
use crate::stream_buffer::net_packet::NetPacket;
...
/// stream session struction
///
/// # Safety
///
/// Its function is safety to use
#[repr(C)]
...
impl StreamSession {
    ...
    /// Send message via pkt
    ///
    /// # Safety
    ///
    /// Call session_send_msg function to complete sending message.
