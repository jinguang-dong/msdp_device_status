...
napi_value DeviceStatusNapi::DeclareEventTypeInterface(napi_env env, napi_value exports)
{
    ...
    napi_status status = napi_create_int32(env,
        static_cast<int32_t>(DevicestatusDataUtils::ActivityEvent::ENTER), &enter);
    if (status != napi_ok) {
    ...
    status = napi_create_int32(env,
        static_cast<int32_t>(DevicestatusDataUtils::ActivityEvent::EXIT), &exit);
    if (status != napi_ok) {
    ...
    status = napi_create_int32(env,
        static_cast<int32_t>(DevicestatusDataUtils::ActivityEvent::ENTER_EXIT), &enter_exit);
    if (status != napi_ok) {
