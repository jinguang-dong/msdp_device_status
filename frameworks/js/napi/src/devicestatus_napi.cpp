...
//     napi_create_int32(env, (int32_t)DevicestatusDataUtils::DevicestatusType::TYPE_STILL, &highStill);
//     napi_create_int32(env, (int32_t)DevicestatusDataUtils::DevicestatusType::TYPE_VERTICAL_POSITION, &fineStill);
//     napi_create_int32(env, (int32_t)DevicestatusDataUtils::DevicestatusType::TYPE_HORIZONTAL_POSITION, &carBluetooth);

//     napi_property_descriptor desc[] = {
//         DECLARE_NAPI_STATIC_PROPERTY("TYPE_STILL", highStill),
//         DECLARE_NAPI_STATIC_PROPERTY("TYPE_VERTICAL_POSITION", fineStill),
//         DECLARE_NAPI_STATIC_PROPERTY("TYPE_HORIZONTAL_POSITION", carBluetooth),
//     };
//     napi_value result = nullptr;
