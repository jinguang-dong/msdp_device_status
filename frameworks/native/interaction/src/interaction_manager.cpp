...
int32_t InteractionManager::ActivateCooperateWithOptions(const std::string &remoteNetworkId,
    int32_t startDeviceId, CooperateMsgInfoCallback callback, const CooperateOptions &options)
{
    return INTER_MGR_IMPL.ActivateCooperateWithOptions(remoteNetworkId, startDeviceId, callback, options);
}
