    ...
    Data& devicestatusData)
{
    ...
    EXPECT_TRUE(devicestatusData.type == Type::TYPE_VERTICAL_POSITION &&
        devicestatusData.value == Value::VALUE_ENTER) <<
...
HWTEST_F (DeviceStatusClientTest, DeviceStatusCallbackTest001, TestSize.Level0)
{
    ...
    sptr<IRemoteDevStaCallbck> cb = new DeviceStatusClientTestCallback();
...
HWTEST_F (DeviceStatusClientTest, GetDeviceStatusDataTest001, TestSize.Level0)
{
    ...
    EXPECT_TRUE(data.type == Type::TYPE_STILL &&
        data.value == Value::VALUE_ENTER) << "GetDeviceStatusData failed";
 ...
 * @tc.type: FUNC
 */
HWTEST_F (DeviceStatusClientTest, GetDeviceStatusDataTest002, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F (DeviceStatusClientTest, GetDeviceStatusDataTest003, TestSize.Level0)
{
...
HWTEST_F (DeviceStatusClientTest, GetDeviceStatusDataTest004, TestSize.Level0)
{
    ...
    EXPECT_TRUE(data.type == Type::TYPE_LID_OPEN &&
        data.value == Value::VALUE_INVALID) << "GetDeviceStatusDataTest004 failed";
    GTEST_LOG_(INFO) << "GetDeviceStatusDataTest004 end";
}

HWTEST_F (DeviceStatusClientTest, GetDeviceStatusDataTest005, TestSize.Level0)
{
    ...
    EXPECT_TRUE(data.type == Type::TYPE_INVALID &&
        data.value == Value::VALUE_INVALID) << "GetDeviceStatusDataTest005 failed";
    GTEST_LOG_(INFO) << "GetDeviceStatusDataTest005 end";
}

HWTEST_F (DeviceStatusClientTest, GetDeviceStatusDataTest006, TestSize.Level0)
{
    ...
    GTEST_LOG_(INFO) << "value: " << data.value;
    EXPECT_TRUE(data.type == Type::TYPE_INVALID &&
        data.value == Value::VALUE_INVALID) << "GetDeviceStatusDataTest006 failed";
