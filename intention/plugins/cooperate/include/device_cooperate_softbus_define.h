...
#ifndef DEVICE_COORPERATE_SOFTBUS_DEFINE_H
#define DEVICE_COORPERATE_SOFTBUS_DEFINE_H
...
enum {
    REMOTE_COORPERATE_START = 1,
    REMOTE_COORPERATE_START_RES = 2,
    REMOTE_COORPERATE_STOP = 3,
    REMOTE_COORPERATE_STOP_RES = 4,
    REMOTE_COORPERATE_STOP_OTHER_RES = 5,
...
#endif  // DEVICE_COORPERATE_SOFTBUS_DEFINE_H
