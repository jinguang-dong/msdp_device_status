    ...
    const DataUtils::Data& devicestatusData)
{
    ...
    EXPECT_TRUE(devicestatusData.type == DataUtils::Type::TYPE_LID_OPEN);
    return true;
}
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest001, TestSize.Level1)
{
    ...
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
    ...
    sleep(2);
    agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        DataUtils::ActivityEvent::ENTER);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest002, TestSize.Level1)
{
    ...
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will not report";
    sleep(2);
    ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest003, TestSize.Level1)
{
    ...
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        ...
        agentEvent1);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent2_->SubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent2);
    EXPECT_TRUE(ret == ERR_OK);
    ...
    agent2_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        DataUtils::ActivityEvent::ENTER);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest004, TestSize.Level1)
{
    ...
    std::shared_ptr<DevicestatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DevicestatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_HORIZONTAL_POSITION, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_HORIZONTAL_POSITION, \
        DataUtils::ActivityEvent::ENTER);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest005, TestSize.Level1)
{
    ...
    std::shared_ptr<DevicestatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DevicestatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_VERTICAL_POSITION, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_VERTICAL_POSITION, \
        DataUtils::ActivityEvent::ENTER);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest006, TestSize.Level1)
{
    ...
    std::shared_ptr<DevicestatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DevicestatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_STILL, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_STILL, \
        DataUtils::ActivityEvent::ENTER);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest007, TestSize.Level1)
{
    ...
    std::shared_ptr<DevicestatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DevicestatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_INVALID, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    ...
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_INVALID, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest008, TestSize.Level1)
{
    ...
    std::shared_ptr<DevicestatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DevicestatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(static_cast<DataUtils::Type>(10), \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest009, TestSize.Level1)
{
    ...
    int32_t ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_INVALID, \
        ...
        agentEvent);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_STILL, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ...
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_INVALID, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_STILL, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
...
HWTEST_F (DevicestatusAgentTest, DevicestatusAgentTest011, TestSize.Level1)
{
    ...
    ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_STILL, \
        ...
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->SubscribeAgentEvent(static_cast<DataUtils::Type>(10), \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_VERTICAL_POSITION, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->SubscribeAgentEvent(DataUtils::Type::TYPE_HORIZONTAL_POSITION, \
        DataUtils::ActivityEvent::ENTER, \
        DataUtils::ReportLatencyNs::Latency_INVALID, \
        agentEvent1);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ...
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_STILL, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->UnSubscribeAgentEvent(static_cast<DataUtils::Type>(10), \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_VERTICAL_POSITION, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_HORIZONTAL_POSITION, \
        DataUtils::ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->UnSubscribeAgentEvent(DataUtils::Type::TYPE_LID_OPEN, \
        DataUtils::ActivityEvent::ENTER);
