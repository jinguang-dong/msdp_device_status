...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest001, TestSize.Level1)
{
    ...
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_LID_OPEN,
        ActivityEvent::ENTER,
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest002, TestSize.Level1)
{
    ...
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_LID_OPEN, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will not report";
    sleep(2);
    ret = agent1_->SubscribeAgentEvent(Type::TYPE_LID_OPEN,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ...
    sleep(2);
    agent1_->UnSubscribeAgentEvent(Type::TYPE_LID_OPEN, ActivityEvent::ENTER);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest003, TestSize.Level1)
{
    ...
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_LID_OPEN,
        ...
        agentEvent1);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent2_->SubscribeAgentEvent(Type::TYPE_LID_OPEN,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent2);
    EXPECT_TRUE(ret == ERR_OK);
    ...
    agent2_->UnSubscribeAgentEvent(Type::TYPE_LID_OPEN, ActivityEvent::ENTER);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest004, TestSize.Level1)
{
    ...
    std::shared_ptr<DeviceStatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DeviceStatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_HORIZONTAL_POSITION,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    agent1_->UnSubscribeAgentEvent(Type::TYPE_HORIZONTAL_POSITION, ActivityEvent::ENTER);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest005, TestSize.Level1)
{
    ...
    std::shared_ptr<DeviceStatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DeviceStatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_VERTICAL_POSITION,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    agent1_->UnSubscribeAgentEvent(Type::TYPE_VERTICAL_POSITION, ActivityEvent::ENTER);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest006, TestSize.Level1)
{
    ...
    std::shared_ptr<DeviceStatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DeviceStatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_STILL,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    agent1_->UnSubscribeAgentEvent(Type::TYPE_STILL, ActivityEvent::ENTER);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest007, TestSize.Level1)
{
    ...
    std::shared_ptr<DeviceStatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DeviceStatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_INVALID,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    ...
    GTEST_LOG_(INFO) << "Open and close the lid, and event will report";
    sleep(2);
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_INVALID, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest008, TestSize.Level1)
{
    ...
    std::shared_ptr<DeviceStatusAgentListenerMockFirstClient> agentEvent =
        std::make_shared<DeviceStatusAgentListenerMockFirstClient>();
    int32_t ret = agent1_->SubscribeAgentEvent(static_cast<Type>(10),
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest009, TestSize.Level1)
{
    ...
    int32_t ret = agent1_->SubscribeAgentEvent(Type::TYPE_INVALID,
        ...
        agentEvent);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->SubscribeAgentEvent(Type::TYPE_STILL,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ...
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_INVALID, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_STILL, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
...
HWTEST_F (DeviceStatusAgentTest, DeviceStatusAgentTest011, TestSize.Level1)
{
    ...
    ret = agent1_->SubscribeAgentEvent(Type::TYPE_STILL,
        ...
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->SubscribeAgentEvent(static_cast<Type>(10),
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->SubscribeAgentEvent(Type::TYPE_VERTICAL_POSITION,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->SubscribeAgentEvent(Type::TYPE_HORIZONTAL_POSITION,
        ActivityEvent::ENTER,
        ReportLatencyNs::Latency_INVALID,
        agentEvent1);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ...
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_STILL, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->UnSubscribeAgentEvent(static_cast<Type>(10), ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_INVALID_VALUE);
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_VERTICAL_POSITION, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_HORIZONTAL_POSITION, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
    ret = agent1_->UnSubscribeAgentEvent(Type::TYPE_LID_OPEN, ActivityEvent::ENTER);
    EXPECT_TRUE(ret == ERR_OK);
