...
public:
    ...
    void Unsubscribe(Type type, ActivityEvent event, const sptr<IRemoteDevStaCallback> callback);
...
private:
    struct classcomp {
        bool operator()(const sptr<IRemoteDevStaCallback> &l, const sptr<IRemoteDevStaCallback> &r) const
        {
