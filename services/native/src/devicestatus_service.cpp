...
int32_t DeviceStatusService::AddSelectedPixelMap(std::shared_ptr<OHOS::Media::PixelMap> pixelMap)
{
    CALL_DEBUG_ENTER;
    int32_t ret = delegateTasks_.PostSyncTask(
        std::bind(&DragManager::AddSelectedPixelMap, &dragMgr_, std::cref(pixelMap)));
    if (ret != RET_OK) {
