...
std::unordered_map<DragType, std::pair<std::string , std::string>> DragDFX::serialStr_ = {
...
int32_t DragDFX::WriteModel(const DragType &dragType, Types ... paras){
    ...
    eventType = (static_cast<int32_t>(dragType) & 1) ? OHOS::HiviewDFX::HiSysEvent::EventType::FAULT :
