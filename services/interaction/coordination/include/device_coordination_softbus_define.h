...
inline constexpr int32_t ENCRYPT_TAG_LEN { 32 };
inline constexpr size_t MSG_MAX_SIZE { 45 * 1024 };
inline constexpr uint32_t SESSION_NAME_SIZE_MAX { 256 };
inline constexpr uint32_t DEVICE_ID_SIZE_MAX { 65 };
inline constexpr uint32_t INTERCEPT_STRING_LENGTH { 20 };
inline constexpr int32_t SESSION_WAIT_TIMEOUT_SECOND { 5 };
inline constexpr int32_t SESSION_SIDE_SERVER { 0 };
inline constexpr int32_t SESSION_SIDE_CLIENT { 1 };
