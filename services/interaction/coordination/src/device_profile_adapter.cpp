...
{
    CALL_INFO_TRACE;
    DistributedDeviceProfile::ServiceProfile servieProfile;
    servieProfile.SetDeviceId(COORDINATION::GetLocalUdid());
    servieProfile.SetServiceName(SERVICE_ID);
    servieProfile.SetServiceType(SERVICE_ID);
    DistributedDeviceProfile::DistributedDeviceProfileClient::GetInstance().PutServiceProfile(servieProfile);
    ...
    DistributedDeviceProfile::DistributedDeviceProfileClient::
        GetInstance().PutCharacteristicProfile(characteristicProfile);
    ...
    FI_HILOGE("DeviceOnlineNotifySyncResult:%{public}d",syncRes);
    return syncRes;
}
...
int32_t DeviceProfileAdapter::UpdateCrossingSwitchState(bool state)
{
    ...
    DistributedDeviceProfile::DistributedDeviceProfileClient::
        GetInstance().PutCharacteristicProfile(characteristicProfile);
    return DistributedDeviceProfile::DistributedDeviceProfileClient::
        GetInstance().PutCharacteristicProfile(characteristicProfile);
}
